...
def getTemplate(movingPlayer, pieceMoved, squareFrom, squareTo, capture=False, capturedPiece=None, check=False,
                castle=False, castlingType=None):
    response = None
...
def getResponse(line):
    ...
    response = getTemplate(movingPlayer, pieceMoved, squareFrom, squareTo, capture=capture, capturedPiece=capturedPiece,
                           check=check, castle=castle, castlingType=castlingType)
