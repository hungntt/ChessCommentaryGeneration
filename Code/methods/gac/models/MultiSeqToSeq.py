...
from Code.methods.baseline_models.conditioned_lm.beam_search import TopN, Caption
from Code.methods.gac.models import torch_utils
from modules import *
...
class MultiSeqToSeqAttn(nn.Module):
    ...
    @staticmethod
    def _initDecoder(encoder_hidden_to_use, init_size):
                ...
                for i, partial_caption in enumerate(partial_captions_list):
                    ...
                    for w in idxs:
                        ...
                        if w == self.cnfg.stop:
                            ...
                            complete_captions[partial_caption.indices[i]].push(beam)
                        else:
                            beam = Caption(sentence, state, logprob, score, metadata=[""])
