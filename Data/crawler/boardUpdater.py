...
startState = []
initDict = {'black_rook': ['a8', 'h8'], 'black_knight': ['b8', 'g8'], 'black_bishop': ['c8', 'f8'],
            'black_queen': ['d8'], 'black_king': ['e8'], 'black_pawn': ['a7', 'b7', 'c7', 'd7', 'e7', 'f7', 'g7', 'h7'],
            'white_rook': ['a1', 'h1'], 'white_knight': ['b1', 'g1'], 'white_bishop': ['c1', 'f1'],
            'white_queen': ['d1'], 'white_king': ['e1'], 'white_pawn': ['a2', 'b2', 'c2', 'd2', 'e2', 'f2', 'g2', 'h2'],
            "": []}
...
pieceCodes = {"": "pawn", "B": "bishop", "K": "king", "N": "knight", "Q": "queen", "R": "rook"}
...
def movePawn(boardIndex, moveColor, destination):
    if moveColor == "white":
...
def updateState(boardState, boardIndex, move):
    ...
    if "x" in move:
        ...
        if len(moveString) == 2:
            ...
            movePawn(boardIndex, moveColor, destination)
        else:
            return
