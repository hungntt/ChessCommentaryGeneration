...
rules[OTHERS] = []
# Multi-word rules
multiRules = {QUALITY: [], ALTERNATE: ["got to", "more inclined"], EXPECTED: [],
              LONG_TERM: ["as then", "and if", "got to", "idea to"],
              STATE: ["worse position", "good position", "description of game", "description about condition"],
              DESCRIBE: ["give up", "gives up", "gave up", "Fischer Variation", "Sicilian Opening", "this is the"],
              OTHERS: []}
